...
{
    /// <inheritdoc />
    public partial class added_new_migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Total = table.Column<decimal>(type: "money", precision: 16, scale: 2, nullable: false),
                    Discount = table.Column<decimal>(type: "money", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalPiecesAvailable = table.Column<int>(type: "int", nullable: false),
                    StockDate = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSaleItems_ProductSales_ProductSaleId",
                        column: x => x.ProductSaleId,
                        principalTable: "ProductSales",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductSaleItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPurchaseItems_ProductPurchases_ProductPurchaseId",
                        column: x => x.ProductPurchaseId,
                        principalTable: "ProductPurchases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductPurchaseItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchaseItems_ProductId",
                table: "ProductPurchaseItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchaseItems_ProductPurchaseId",
                table: "ProductPurchaseItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSaleItems_ProductSaleId",
                table: "ProductSaleItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductSizes_ProductUnitId",
                table: "ProductSizes",
